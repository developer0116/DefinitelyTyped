    ...
    extends Omit<React.TextareaHTMLAttributes<HTMLTextAreaElement>, "onChange" | "onBlur" | "onKeyDown" | "onSelect">
{
    ...
    onMentionClick?: OnMentionClickHandlerFunc | undefined;
...
/**
 * Defines the function signature for implementing @see MentionsInputProps.onMentionClick
 */
export type OnMentionClickHandlerFunc = (
    id: any
) => void;
